  <!-- mentalhealth.inc.php -->
  <!-- Main Section -->
  <section id="main-mentalhealth">
  ...
  <!-- Content Section -->
  <section id="content-mentalhealth">
    <div class="content">
      <div class="container my-5">
        <div class="row mt-5">
          <div class="col-lg-6">
            <h2>"Strong mind, strong life"</h2>
            <p>Mental health refers to a person's emotional, psychological, and social well-being. It encompasses how individuals think, feel, and behave, affecting how they handle stress, make decisions, and relate to others. Mental health is crucial to a healthy lifestyle because it impacts every aspect of life, from relationships and work performance to physical health and overall quality of life. Good mental health promotes resilience, positive self-esteem, effective coping strategies, and healthy relationships. It also reduces the risk of mental health disorders such as depression, anxiety, and substance abuse, contributing to overall well-being and a fulfilling life.</p>        
          </div>
          <div class="col-lg-6">
            <img src="images/mentalhealth-importance.jpg" alt="importance of mental health">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container my-5">
        <div class="row">
          <div class="col-lg-6 text-start">
            <img src="images/mentalhealth-tips.jpg" alt="tips to improve mental health">
          </div>
          <div class="col-lg-6 text-start pb-3 mb-5">
            <h2>Tips to Improve Mental Health</h2>
            <div id="accordion">
              <div class="card mb-3">
  ...
  <section id="card-list-1" class="py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="card mb-5">
            <img src="images/mentalhealth-card1.jpg" class="card-img-top" alt="generalized anxiety disorder">
            <div class="card-body">
        ...
        <div class="col-lg-4">
          <div class="card mb-5">
            <img src="images/mentalhealth-card2.jpg" class="card-img-top" alt="obsessive-compulsive disorder">
            <div class="card-body">
        ...
        <div class="col-lg-4">
          <div class="card mb-5">
            <img src="images/mentalhealth-card3.jpg" class="card-img-top" alt="post-traumatic stress disorder">
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="card mb-5">
            <img src="images/mentalhealth-card4.jpg" class="card-img-top" alt="bipolar disorder">
            <div class="card-body">
        ...
        <div class="col-lg-4">
          <div class="card mb-5">
            <img src="images/mentalhealth-card5.jpg" class="card-img-top" alt="panic disorder">
            <div class="card-body">
        ...
        <div class="col-lg-4">
          <div class="card mb-5">
            <img src="images/mentalhealth-card6.jpg" class="card-img-top" alt="dissociative disorders">
            <div class="card-body">
