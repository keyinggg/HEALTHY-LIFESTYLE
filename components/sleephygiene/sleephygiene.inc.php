  <!-- sleephygiene.inc.php -->
  <!-- Main Section -->
  <section id="main-sleephygiene">
  ...
  <!-- Content Section -->
  <section id="content-sleephygiene">
  <div class="content">
    <div class="container my-5">
      <div class="row mt-5">
        <div class="col-lg-6">
          <h2>"Sleep well, live well"</h2>
          <p>Sleep hygiene refers to the habits and practices that promote good sleep quality and quantity. It includes factors such as consistent sleep schedule, comfortable sleep environment, bedtime rituals, and avoiding sleep disruptors like caffeine and screen time before bed. Good sleep hygiene is essential for a healthy lifestyle because it directly impacts physical, mental, and emotional well-being. Adequate and quality sleep supports overall health by allowing the body to rest, repair, and recharge. It enhances cognitive function, mood regulation, immune system function, and hormone balance. Poor sleep hygiene, on the other hand, can lead to sleep disturbances, daytime fatigue, irritability, decreased concentration, and increased risk of chronic health conditions. By prioritizing good sleep hygiene practices, individuals can improve their sleep quality and contribute to a healthier and more vibrant lifestyle.</p>        
        </div>
        <div class="col-lg-6">
          <img src="images/sleephygiene-importance.jpg" alt="why is nutrition important">
        </div>
      </div>
    </div>
</div>
  ...
  <div class="container my-5">
    <div class="row">
      <div class="col-lg-6 text-start">
        <img src="images/sleephygiene-tips.jpg" alt="how to get started with physical activity">
      </div>
      <div class="col-lg-6 text-start pb-3 mb-5">
        <h2>Tips to Improve Sleep Quality</h2>
        <div id="accordion">
          <div class="card mb-3">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active"> -->
            <div class="row">
              <div class="col-lg-4">
                <div class="card mb-5">
                  <img src="images/sleephygiene-card1.jpg" class="card-img-top" alt="how to use the nutrition facts label">
                  <div class="card-body">
              ...
              <div class="col-lg-4">
                <div class="card mb-5">
                  <img src="images/sleephygiene-card2.jpg" class="card-img-top" alt="food groups and nutrition">
                  <div class="card-body">
              ...
              <div class="col-lg-4">
                <div class="card mb-5">
                  <img src="images/sleephygiene-card3.jpg" class="card-img-top" alt="food groups and nutrition">
                  <div class="card-body">
